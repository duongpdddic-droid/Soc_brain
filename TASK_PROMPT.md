...
- Target Branch: task/integrate-bootstrapper-into-soc-control-loop-20260924-075429
- Base: origin/main
- PR Number: 229
...
Pre-provisioned isolated worktree: worktrees/task/integrate-bootstrapper-into-soc-control-loop-20260924-075429
If it must be recreated:
  git worktree add -b task/integrate-bootstrapper-into-soc-control-loop-20260924-075429 worktrees/task/integrate-bootstrapper-into-soc-control-loop-20260924-075429 origin/main

## 3. GitHub Label Lifecycle (R8)
  gh pr edit 229 --add-label "status:in-progress" --remove-label "status:queued,status:changes-requested"
...
3. Export the diff bundle:
   ...
   git diff origin/main...HEAD > artifacts/diffs/pr-229-changes.diff
   Compress-Archive -Path artifacts/diffs/pr-229-changes.diff -DestinationPath artifacts/diffs/pr-229-diff.zip -Force
4. gh pr edit 229 --add-label "status:review-requested" --remove-label "status:in-progress"
