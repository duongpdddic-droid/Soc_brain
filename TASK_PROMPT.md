...
## 3. GitHub Label Lifecycle (R8)
  gh pr edit 232 --add-label "status:in-progress" --remove-label "status:queued,status:changes-requested"
...
4. gh pr edit 232 --add-label "status:review-requested" --remove-label "status:in-progress"
