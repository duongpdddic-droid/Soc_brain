...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        executorPreference: { type: 'string', enum: ['cline', 'opencode', 'auto'], description: 'legacy routing preference; retained for compatibility.' },
        executor: { type: 'string', enum: ['opencode', 'command-code'], default: 'opencode', description: 'canonical executor provider.' },
      },
