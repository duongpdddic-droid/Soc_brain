...
- On start: gh pr edit 232 --add-label "status:in-progress"
- On handoff: gh pr edit 232 --add-label "status:review-requested" --remove-label "status:in-progress"
...
- [ ] Diff bundle exported to artifacts/diffs/pr-232-diff.zip (R5).
...
- git diff origin/main...HEAD > artifacts/diffs/pr-232-changes.diff
- Compress-Archive -Path artifacts/diffs/pr-232-changes.diff -DestinationPath artifacts/diffs/pr-232-diff.zip -Force
