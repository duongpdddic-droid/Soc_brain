...
- PR Number: 229
- Issue Number: none
- Worktree: worktrees/task/integrate-bootstrapper-into-soc-control-loop-20260924-075429
...
- On start: gh pr edit 229 --add-label "status:in-progress"
- On handoff: gh pr edit 229 --add-label "status:review-requested" --remove-label "status:in-progress"
...
- [ ] Diff bundle exported to artifacts/diffs/pr-229-diff.zip (R5).
