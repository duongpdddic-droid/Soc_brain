...
| `origin/main` tại thời điểm khảo sát | `a3b42e4102116a32f0ac650888f81c3aeccee612` |
| HEAD của worktree | `d655df5ba2a0e0e5caee10822d071a5c16b8481` |
...
| **234** | docs(backlog): backlog triage & audit report (PR này) | OPEN / **DRAFT** | 1 / 0 · docs mới | **merge-candidate** | R5 diff bundle; Roadmap §9 | Sau khi test PASS + R5 bundle → handoff review rồi Bố merge. |
