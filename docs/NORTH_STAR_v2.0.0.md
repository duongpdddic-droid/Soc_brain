...
**North Star v2.0.0 replaces the previous strategic framing where Soc_brain was primarily an autonomous coding-agent orchestrator. Coding remains the first proving domain; the target is an adaptive personal AI control plane.**
